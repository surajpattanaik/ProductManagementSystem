...
public class ProductManagementDAO {
	...
	public static List<Product> getAllProducts()
	{
		...
		try
		{
			...
			while(rs.next())
			{
				Product product = new Product(rs.getString("prod_id"),rs.getString("prod_name"),rs.getString("prod_catagory"),rs.getInt("prod_price"));
	...
	public static Product getProductById(String productId)
	{
		...
		try
		{
			...
			while(rs.next())
			{
				product = new Product(rs.getString("prod_id"),rs.getString("prod_name"),rs.getString("prod_catagory"),rs.getInt("prod_price"));
			}
		}
		catch(Exception e)
		{
	...
	public static int updateProduct(Product product)
	{
		...
		{
			Connection conn = DBUtil.getConnection();
			PreparedStatement ps= conn.prepareStatement("UPDATE product SET prod_name=?, prod_catagory=?, prod_price=? WHERE prod_id=?");
